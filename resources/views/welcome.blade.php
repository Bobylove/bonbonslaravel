...
<body>
    ...
    <div>
        ...
        <div class="ui card">
            <h3>il vous reste : {{$value->qty}} {{$value->name}} </h3>
            <div class="ui extra content">
                <div class="ui three column grid">
                    <form action="/welcome/sell/{{$value->id}}" method="post">
                       {{csrf_field()}}
                       <input class="ui black button" type="submit" value="moins"> 
                   </form>

                   <form action="/welcome/restock/{{$value->id}}" method="post">
                       {{csrf_field()}}
                       <input class="ui orange button" type="submit" value="plus"> 
                   </form>
